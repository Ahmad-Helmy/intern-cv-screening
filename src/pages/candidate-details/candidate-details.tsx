      ...
      <div className="details-main-container">
        <div className="left-container">
          ...
          <section aria-label="Projects">
            <CardInfo title="Projects">
              <ul className="candidate-list">
                <li>
                  <p className="description">
                    Built a full-stack e-commerce platform with React and Spring
                    Boot serving 1k+ mock orders.
                  </p>
                </li>
                <li>
                  <p className="description">
          ...
          <section aria-label="Experience">
            <CardInfo title="Experience">
              <ul className="candidate-list">
                ...
                <li>
                  <p className="description">
                    Teaching assistant for an introductory programming course (2
                    semesters).
                  </p>
                </li>
              </ul>
          ...
          <section aria-label="Extracurricular">
            <CardInfo title="Extracurricular">
              <ul className="candidate-list">
                ...
                <li>
                  <p className="description">
                    Hackathon finalist — built a sustainability tracking app in
                    24h.
                  </p>
                </li>
              </ul>
          ...
          <section aria-label="AI Evaluation Report">
            <CardInfo title="AI Evaluation Report">
              <p className="description">
                Mohammed Khalil demonstrates strong alignment with the Software
                Engineering 2026 criteria. Technical skills and project work are
                the primary contributors to the overall score, weighted against
                academic performance and communication. The candidate&apos;s CV
                indicates 8 relevant skills and 2 notable projects.
              </p>
            </CardInfo>
          </section>
        </div>
        <section className="right-container" aria-label="Candidate Scores">
          <CardInfo title="Score Overview" icon={<img src={barChartIcon} />}>
            ...
            <p>
              Top performer across technical and communication dimensions; clear
              nomination.
            </p>
            <p>
